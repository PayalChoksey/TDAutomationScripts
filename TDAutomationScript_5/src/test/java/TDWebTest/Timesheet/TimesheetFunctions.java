...
import TDWebTest.GlobalProperties.GlobalFunctions;
import TDWebTest.GlobalProperties.GlobalObjects;
import TDWebTest.GlobalProperties.TDWeb_GlobalSetup;
import TDWebTest.NavigateToPages.NavigationFunctions;

public class TimesheetFunctions extends TDWeb_GlobalSetup {
	...
	public void GetTimesheetReportForAllUsers() throws IOException {
